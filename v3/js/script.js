...
var RR = {
	...
	addDefaultSections: function() {
		RR.addSection({ type: "text", title: "Objective", content: "Seeking a position in the accounting field where excellent analytical and technical skills can be used to improve the company's profitability." }, false);
		RR.addSection({ type: "text", title: "Professional Summary", content: "Highly experienced Customer Service professional. Able to handle a high volume of customer calls in a fast- paced environment, with minimum supervision, while maintaining emphasis on the highest quality of consumer service. Excellent listening skills, oral and written communications. Comfortable in interacting with all levels of the organization and public. Excellent problem solving and negotiating skills. Able to make decisions independently and quickly with minimal escalations." }, false);
		RR.addSection({ type: "experience", title: "Experience" }, false);
		RR.addSection({ type: "text", title: "Skills", content: "Analysis, Accounts Payable/Payroll, Microsoft Office, Written and Verbal Communications, Detail Oriented, Multi Tasking, Organization/Prioritizing, Data Entry" }, false);
